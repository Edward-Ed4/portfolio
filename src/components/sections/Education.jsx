    ...
    <section id="education" className="py-28 px-6 relative" style={{ background: "#050810" }}>
      ...
      <div className="max-w-6xl mx-auto">
        <ScrollReveal>
          ...
          <h2
            className="font-black leading-none tracking-tight mt-3 mb-4"
        ...
        <div className="space-y-5">
          {certifications.map((cert, i) => (
            <ScrollReveal key={cert.title} delay={i * 100}>
              <div
                className="group flex flex-col md:flex-row gap-6 p-7 rounded-2xl transition-all duration-300"
                style={{
                  background: cert.bg,
