...
export function Projects() {
  return (
    <section id="projects" className="py-28 px-6 relative" style={{ background: "#030712" }}>
        ...
        <div className="flex flex-col gap-8">
          {projects.map((project) => (
            <ScrollReveal key={project.title} delay={100}>
              <div
                className="project-card group rounded-2xl overflow-hidden transition-all duration-500"
              ...
              >
                ...
                <div className="relative overflow-hidden" style={{ height: "220px" }}>
                  ...
                  <div
                    ...
                    style={{
                      background: "linear-gradient(to bottom, rgba(3,7,18,0.1) 0%, rgba(3,7,18,0.92) 100%)",
                    }}
                  />
                  ...
                  <div className="absolute bottom-4 left-6 flex gap-6">
                    {project.stats.map((s) => (
                      <div key={s.label}>
                        <div className="text-base font-bold" style={{ color: project.accentColor }}>
                          {s.value}
                        </div>
