    ...
    <section id="about" className="py-28 px-6 relative" style={{ background: "#030712" }}>
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <ScrollReveal direction="left">
            <div className="space-y-5">
              <p className="text-gray-300 text-lg leading-relaxed">
                ...
                and{" "}
                <span className="font-semibold" style={{ color: "#a78bfa" }}>Backend Developer</span>{" "}
              ...
              <div className="grid grid-cols-3 gap-4 pt-6">
                {[
                  ...
                  <div key={stat.label} className="stat-card">
                    <div className="text-2xl font-bold" style={{ color: "#a78bfa" }}>{stat.number}</div>
          ...
          {/* Right: What I Do numbered cards */}
