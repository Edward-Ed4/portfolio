...
const learningItems = [
  {
    num: "01", title: "Advanced Machine Learning", subtitle: "Deep Learning",
    description: "Deepening expertise in neural network architectures, transformers, and deploying production-grade ML pipelines.",
    progress: 72, status: "Active Focus",
    statusColor: "#22d3ee", statusBg: "rgba(34,211,238,0.12)", accent: "#22d3ee",
  },
  {
    num: "02", title: "Cloud Architecture", subtitle: "AWS & Serverless",
    description: "Expanding beyond Lambda, learning ECS, RDS, CloudFormation, and designing resilient distributed systems.",
    progress: 58, status: "Developing",
    statusColor: "#06b6d4", statusBg: "rgba(6,182,212,0.12)", accent: "#06b6d4",
  },
  {
    num: "03", title: "React & Frontend", subtitle: "Full-Stack",
    description: "Building richer front-end skills to complement my backend strength and ship complete end-to-end products.",
    progress: 45, status: "Learning",
    statusColor: "#67e8f9", statusBg: "rgba(103,232,249,0.1)", accent: "#67e8f9",
  },
];
      ...
      <div className="max-w-6xl mx-auto relative">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {learningItems.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 100}>
              <div className="p-6 rounded-2xl h-full flex flex-col gap-4 transition-all duration-300 hover:-translate-y-1"
        ...
        <ScrollReveal delay={300}>
          <div className="mt-10 p-6 rounded-2xl"
            style={{ borderLeft: "3px solid rgba(6,182,212,0.4)", background: "rgba(6,182,212,0.03)", border: "1px solid rgba(6,182,212,0.08)", borderLeftWidth: "3px" }}>
